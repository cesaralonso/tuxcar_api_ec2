...
router
        ...
        passport.authenticate('jwt', { session: true }, (err, auth_data, info) => {
            ...
            permissions.module_permission(auth_data.modules, 'pago', auth_data.user.super, 'readable', (error, permission) => {
                if (permission.success) {
                    ...
                    Pago.findByIdChofer(req.params.idchofer, created_by, req.mysql, (error, data) => {
    ...
    .get('/estado/:idestado', (req, res, next) => {
        passport.authenticate('jwt', { session: true }, (err, auth_data, info) => {
            ...
            permissions.module_permission(auth_data.modules, 'pago', auth_data.user.super, 'readable', (error, permission) => {
                if (permission.success) {
                    const created_by = (permission.only_own) ? auth_data.user.idsi_user : false;
                    Pago.findByIdEstado(req.params.idestado, created_by, req.mysql, (error, data) => {
                        return Pago.response(res, error, data);
                    })
                } else {
                    return Pago.response(res, error, permission);
    ...
    .get('/', (req, res, next) => {
        passport.authenticate('jwt', { session: true }, (err, auth_data, info) => {
            ...
            permissions.module_permission(auth_data.modules, 'pago', auth_data.user.super, 'readable', (error, permission) => {
                if (permission.success) {
                    const created_by = (permission.only_own) ? auth_data.user.idsi_user : false;
                    Pago.all(created_by, req.mysql, (error, data) => {
                        return Pago.response(res, error, data);
                    })
                } else {
                    return Pago.response(res, error, permission);
    ...
    .get('/count', (req, res, next) => {
        passport.authenticate('jwt', { session: true }, (err, auth_data, info) => {
            ...
            permissions.module_permission(auth_data.modules, 'pago', auth_data.user.super, 'readable', (error, permission) => {
                if (permission.success) {
                    Pago.count(req.mysql, (error, data) => {
                        return Pago.response(res, error, data);
                    })
                } else {
                    return Pago.response(res, error, permission);
    ...
    .get('/exist/:id', (req, res, next) => {
        passport.authenticate('jwt', { session: true }, (err, auth_data, info) => {
            ...
            permissions.module_permission(auth_data.modules, 'pago', auth_data.user.super, 'readable', (error, permission) => {
                if (permission.success) {
                    Pago.exist(req.params.id, req.mysql, (error, data) => {
                        return Pago.response(res, error, data);
                    })
                } else {
                    return Pago.response(res, error, permission);
    ...
    .get('/:id', (req, res, next) => {
        passport.authenticate('jwt', { session: true }, (err, auth_data, info) => {
            ...
            permissions.module_permission(auth_data.modules, 'pago', auth_data.user.super, 'readable', (error, permission) => {
                if (permission.success) {
                    const created_by = (permission.only_own) ? auth_data.user.idsi_user : false;
                    Pago.findById(req.params.id, created_by, req.mysql, (error, data) => {
                        return Pago.response(res, error, data);
                    })
                } else {
                    return Pago.response(res, error, permission);
    ...
    .delete('/:id', (req, res, next) => {
        passport.authenticate('jwt', { session: true }, (err, auth_data, info) => {
            ...
            permissions.module_permission(auth_data.modules, 'pago', auth_data.user.super, 'deleteable', (error, permission) => {
                if (permission.success) {
                    const created_by = (permission.only_own) ? auth_data.user.idsi_user : false;
                    Pago.logicRemove(req.params.id, created_by, req.mysql, (error, data) => {
                        return Pago.response(res, error, data);
                    })
                } else {
                    return Pago.response(res, error, permission);
        ...
        passport.authenticate('jwt', { session: true }, (err, auth_data, info) => {
            ...
            permissions.module_permission(auth_data.modules, 'pago', auth_data.user.super, 'updateable', (error, permission) => {
                if (permission.success) {
                    ...
                    const created_by = (permission.only_own) ? auth_data.user.idsi_user : false;
                    Pago.update(_pago, created_by, req.mysql, (error, data) => {
                        return Pago.response(res, error, data);
                    })
                } else {
                    return Pago.response(res, error, permission);
        ...
        passport.authenticate('jwt', { session: true }, (err, auth_data, info) => {
            ...
            permissions.module_permission(auth_data.modules, 'pago', auth_data.user.super, 'writeable', (error, permission) => {
                if (permission.success) {
                    ...
                    Pago.insert( _pago, req.mysql, (error, data) =>{
                        return Pago.response(res, error, data);
                    });
                } else {
                    return Pago.response(res, error, permission);
